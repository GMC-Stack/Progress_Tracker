...
| Sheet | Description |
|---|---|
| 📋 Instructions | Full glossary of all metrics and activities |
...
The tracker monitors 5 dimensions, each with 3 indicators:

- ⚡ **Physical** — Sleep quality, Energy level, Nutrition
- 🧠 **Mental** — Focus and concentration, Emotional calm, Intentionality
- 🌿 **Social** — Social connection, Optimism, Motivation and curiosity
- ✨ **Spiritual / Values** — Mindfulness practice, Values alignment, Presence and gratitude
- 📚 **Personal Growth** — Reading, Self-reflection, Skill development
...
- Basic familiarity with Excel (no macros or VBA required)
- Some features may not work correctly in Google Sheets or older Excel versions
...
You are free to:
- ✅ Use and adapt the tracker for personal or professional purposes
- ✅ Share and redistribute it freely
- ✅ Build upon it and create new versions
...
Built by **Guido Matteo Cavicchioli**  
[LinkedIn Profile](https://www.linkedin.com/in/guido-matteo-cavicchioli-743089204)
